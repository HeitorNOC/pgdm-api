...
export function AuthenticationMagicLinkTemplate({
  ...
  const previewText = `Faça login na Ballet World`
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            <Section className="mt-[32px] text-center">
              <span className="text-2xl">PGDM</span>
            </Section>
            <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              Faça login na Ballet World
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Você solicitou um link para login na Ballet World através do email{' '}
              {userEmail}.
            </Text>
